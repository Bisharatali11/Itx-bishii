...
if ([
  ...
  if ([
   ...
   if ((event.body.toLowerCase() == "Shehzada") || (event.body.toLowerCase() == "Shehzada Ali") || (event.body.toLowerCase() == "shehzada") || (event.body.toLowerCase() == "SHEHZADA")) {
  ...
  if  ((event.body.toLowerCase() == "Sultan") || (event.body.toLowerCase() == "SULTAN") || (event.body.toLowerCase() == "sultan")) {
    return api.sendMessage("Is Hacker ko Na Bulao Khtrnak Hecker Ha Kahiw Meko Na Ura DYw", threadID);
    

   if  ((event.body.toLowerCase() == "Zidi") || (event.body.toLowerCase() == "zidi") || (event.body.toLowerCase() == "ZIDI")) {
     return api.sendMessage("Is ThRkiw ko na bulao 1num ka inTerNaTional ThRkiw Ha", threadID);


    if  ((event.body.toLowerCase() == "Shehzada") || (event.body.toLowerCase() == "shehzada") || (event.body.toLowerCase() == "SHEHZADA")) {
      return api.sendMessage("HYee MaRYww ShReef Owner ka Nam liYa 😁 Wo BusYw h0Ga WoRk Ma MeK0w Bolo Ma H0n yHn", threadID);
  ...
  if ((event.body.toLowerCase() == "🤔") || (event.body.toLowerCase() == "🤨")) {
     return api.sendMessage("️Itna Mat Soch phaly hi dimag ni ha tujh ma", threadID);
   };
